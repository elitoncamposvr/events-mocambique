            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="w-full flex justify-end">
                        <a class="btn-link" href="{{ route('users.create') }}">Criar novo usuário</a>
                    </div>
                    <div class="w-full flex text-sm font-semibold py-2">
                        <div class="w-1/6">ID</div>
                        <div class="w-2/6">Nome do Usuário</div>
                        <div class="w-2/6">E-mail</div>
                    </div>
                    ...
                    <div class="w-full flex justify-center pt-2">
                        <a class="mr-2 btn-link" href="{{ $users->previousPageUrl() }}">Anterior</a>
                        <a class="ml-2 btn-link" href="{{ $users->nextPageUrl() }}">Proxima</a>
                </div>
            </div>
        </div>
    </div>
